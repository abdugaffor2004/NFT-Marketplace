...
const Auction = () => {
  return (
    ...
    >
      <div
        style={{
          background: 'linear-gradient(0deg, rgba(162,89,255,1) 3%, rgba(255,255,255,0) 100%)',
        }}
        className="w-full min-h-[590px] flex justify-center items-end"
      >
        <div className="mb-10 min-w-[315px] h-[430px] sm:flex sm:items-end sm:justify-between sm:mb-[60px] sm:mx-[82px] md:mx-[115px] sm:w-full sm:h-[210px] xl:w-[1400px]">
          <div className="mr-5">
            ...
            <Button
              className="font-workSans mt-[1.875rem] bg-white text-black hidden sm:flex"
              icon={eyeIcon}
              title="See NFT"
            />
          </div>
          ...
          <Button
            className=" font-workSans mt-[1.875rem] bg-white text-black sm:hidden"
            icon={eyeIcon}
            title="See NFT"
          />
        </div>
