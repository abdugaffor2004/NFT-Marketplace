...
const Hero = () => (
  ...
  <section className='text-white flex flex-col sm:flex-row sm:justify-between lg:justify-between'>
    ...
    <div className='sm:w-[330px] md:w-[510px] sm:mr-[1.875rem]'>
      ...
      <div className='sm:hidden sm:w-[330px] sm:h-[259.38px] md:w-[510px] md:h-[401px] lg:w-[480px] lg:h-[377.28px]  mb-[2.5rem]'>
        <div><img src={imagePlaceholder} alt="image" className='w-full rounded-t-[1.25rem]' /></div>
    ...
    <div className='hidden sm:block sm:w-[300px] md:w-[510px] md:h-[401px] lg:w-[560px] mb-[2.5rem]'>
      <div><img className='rounded-t-[1.25rem] lg:w-[600px]' src={imagePlaceholder} alt="image" /></div>
      <div className='bg-backgroundSecond px-5 py-[1.375rem]  rounded-b-[1.25rem]'>
        <h3 className='font-semibold text-[1.375rem]'>Space Walking</h3>
        <div className='mt-2.5 flex'>
          <img src={avatar} alt="AvatarIcon" />
