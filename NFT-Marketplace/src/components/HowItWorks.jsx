...
const HowItWorks = () => (
    ...
    <section className='mt-[2.5rem] text-white'>
        <div>
        ...
        <div className='sm:flex sm:gap-[1.875rem] lg:justify-center'>
            ...
            {howItWorksCards.map( (item) =>(
                <div key={item.title} className='first:mt-10 mt-5 bg-backgroundSecond flex p-5 rounded-[1.25rem] xs:items-center sm:flex-col sm:text-center sm:min-w-[13.125rem] sm:min-h-[21.0625rem] sm:mt-10 sm:first:mt-10 md:p-[1.875rem] lg:w-full lg:mt-12 lg:first:mt-12'>
                    <img className='min-w-[6.25rem] sm:min-w-[10rem] md:w-[13.75rem] object-contain mr-5 sm:mr-0' src={getImage(item.icon, "howItWorks")} alt="Icon" />
