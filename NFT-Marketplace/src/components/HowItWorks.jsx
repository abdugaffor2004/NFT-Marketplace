    ...
    <section className='mt-[5rem] text-white'>
        ...
        <div className='sm:flex sm:gap-[1.875rem] lg:justify-center'>
            ...
            {howItWorksCards.map( (item) =>(
                <div key={item.title} className='mt-10 bg-backgroundSecond flex p-5 rounded-[1.25rem] xs:items-center sm:flex-col sm:text-center sm:min-w-[13.125rem] sm:min-h-[21.0625rem] md:p-[1.875rem] lg:min-w-[21.875rem]'>
