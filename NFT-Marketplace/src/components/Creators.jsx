...
const Creators = () => {
    ...
    return(
        <section className='mt-[5rem] text-white'>
                    ...
                    <div key={item.grade} className='bg-backgroundSecond flex items-center p-5 rounded-[1.25rem] mb-5 last:mb-0 sm:last:mb-5 md:flex-col md:items-center md:text-center md:mb-[1.875rem]'>
                        ...
                        <div className='md:mt-5'>
                            ...
                            <div className='hidden ss:block md:mt-[5px]'>
                                <span className=" font-workSans font-normal text-base text-grey mr-1.5">Total Sales: </span>
            ...
            <div className='w-full flex justify-center sm:hidden mt-10'><Button title="View Rankings" icon={buttonIcon} outlined={true} /></div>
